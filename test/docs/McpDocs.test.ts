...
describe('MCP documentation', () => {
  it('documents Continue MCP setup via AT Series hub.js', () => {
    ...
    expect(sample).toContain('AT Series');
    expect(sample).toContain('.at-series/mcp/hub.js');
    expect(sample).not.toContain('mcp-server.js');
    ...
    expect(readme).toContain('AT Series');
    expect(readme).toContain('hub.js');
    expect(readme).not.toContain('dist/mcp-server.js');
    ...
    expect(usage).not.toContain('dist/mcp-server.js');
    expect(usage).not.toContain('languageModelTools');
    ...
    expect(chineseReadme).toContain('AT Series');
